...
import com.mlc.controller.WelcomeController;
...
public class WelcomeControllerTest {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Medical Legal Cloud")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, Medical Legal Cloud")));
